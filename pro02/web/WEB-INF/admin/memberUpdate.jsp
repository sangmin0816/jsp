    ...
    <div class="container contents text-center">
        ...
        <form class="form_row" action="${rootPath}/MemberUpdateProAdmin.do" method="post" onsubmit="return inform(this)">
            ...
            <div class="row">
                ...
                <div class="col-4"><input type="text" class="form-control" id="address1" name="address1" value="${member.address1}"></div>
            ...
            <div class="row">
                ...
                <div class="col-8"><input type="text" class="form-control" id="address2" name="address2" value="${member.address2}"></div>
