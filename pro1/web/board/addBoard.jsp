...
<head>
    ...
    <style>
        ...
        .board_tb tr{width: 100%;}
        .board_tb th{background-color: darkturquoise;}
        ...
        .indata { display:inline-block; width: 100%; height: 48px; line-height: 48px; text-indent:14px; font-size:18px; }
